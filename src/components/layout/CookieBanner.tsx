      ...
      <div className="max-w-2xl mx-auto bg-white border border-gray-200 rounded-2xl shadow-xl p-5">
        <div className="flex items-start justify-between gap-4 mb-3">
          <p className="text-sm text-gray-700 leading-relaxed">
            ...
            <a href="/premium" className="text-accent-700 font-medium hover:underline">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <a
            href="/premium"
            className="px-4 py-2 border border-zinc-200 text-accent-700 text-sm font-medium rounded-lg hover:bg-zinc-50 transition-colors"
          >
