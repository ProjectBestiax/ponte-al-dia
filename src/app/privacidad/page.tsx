...
export default function PrivacidadPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-8 prose prose-sm prose-gray">
      <h1 className="text-2xl font-bold text-zinc-900 mb-2">Política de Privacidad</h1>
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold text-zinc-800 mb-2">2. Datos que recopilamos</h2>
        <ul className="text-zinc-600 text-sm space-y-1 list-disc pl-5">
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold text-zinc-800 mb-2">3. Finalidad del tratamiento</h2>
        <ul className="text-zinc-600 text-sm space-y-1 list-disc pl-5">
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold text-zinc-800 mb-2">4. Base legal</h2>
        <p className="text-zinc-600 text-sm">
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold text-zinc-800 mb-2">5. Terceros y transferencias internacionales</h2>
        <ul className="text-zinc-600 text-sm space-y-1 list-disc pl-5">
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold text-zinc-800 mb-2">7. Tus derechos</h2>
