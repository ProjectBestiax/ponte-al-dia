    ...
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          >
            Crea tu cuenta en 5 segundos
          </h1>
          <p className="text-sm text-zinc-500 mt-2">
            Gratis. No publicaremos nada en tu nombre.
          </p>
        </div>

        <div className="bg-white border border-zinc-200 rounded-2xl p-6 shadow-sm">
          {/* OAuth buttons — lo primero visible */}
          <div className="space-y-3">
            ...
            <button
              onClick={() => signIn("github", { callbackUrl: "/bienvenida" })}
          ...
          {/* Formulario email — colapsado por defecto */}
          {!showEmail ? (
            <button
              type="button"
              onClick={() => setShowEmail(true)}
              className="w-full flex items-center justify-center gap-2 border border-zinc-200 rounded-lg px-4 py-3 text-sm text-zinc-500 hover:bg-zinc-50 transition-colors"
            >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-accent-600 text-white rounded-lg px-4 py-3 text-sm font-medium hover:bg-accent-700 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
              >
        ...
        <p className="text-center text-sm text-zinc-500 mt-6">
          ¿Ya tienes cuenta?{" "}
          <a href="/login" className="text-accent-600 font-medium hover:underline">
            Inicia sesión
          </a>
        </p>

        <p className="text-center text-xs text-zinc-400 mt-3">
          Al registrarte aceptas nuestros <a href="/terminos" className="underline">términos</a> y{" "}
