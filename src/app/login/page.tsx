...
export default function LoginPage() {
  ...
  const [error, setError] = useState(
    errorParam === "CredentialsSignin" ? "Email o contraseña incorrectos." : "",
  );
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-zinc-200 rounded-2xl p-6 shadow-sm">
          ...
          {process.env.NODE_ENV === "development" && (
            <a
              href="/api/dev/login"
              className="mt-3 w-full flex items-center justify-center gap-2 border border-dashed border-amber-400 bg-amber-50 rounded-lg px-4 py-3 text-sm font-semibold text-amber-700 hover:bg-amber-100 transition-colors"
            >
        ...
        <p className="text-center text-sm text-zinc-500 mt-6">
          ¿No tienes cuenta?{" "}
          <a href="/registro" className="text-accent-600 font-medium hover:underline">
            Regístrate aquí
          </a>
        </p>
